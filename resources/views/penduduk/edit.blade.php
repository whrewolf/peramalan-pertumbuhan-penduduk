<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Data Penduduk</h2>
    </x-slot>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="month" name="periode" id="periode" 
                                   value="{{ old('periode', $penduduk->periode) }}" 
                        ...
                        <div>
                            ...
                            <input type="number" name="kelahiran" id="kelahiran" 
                                   value="{{ old('kelahiran', $penduduk->kelahiran) }}" 
                        ...
                        <div>
                            ...
                            <input type="number" name="kematian" id="kematian" 
                                   value="{{ old('kematian', $penduduk->kematian) }}" 
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required min="0">
                        ...
                        <div>
                            ...
                            <input type="number" name="migrasi_masuk" id="migrasi_masuk" 
                                   value="{{ old('migrasi_masuk', $penduduk->migrasi_masuk) }}" 
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required min="0">
                        ...
                        <div>
                            ...
                            <input type="number" name="migrasi_keluar" id="migrasi_keluar" 
                                   value="{{ old('migrasi_keluar', $penduduk->migrasi_keluar) }}" 
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required min="0">
                        ...
                        <div>
                            ...
                            <input type="number" name="jumlah_penduduk" id="jumlah_penduduk" 
                                   value="{{ old('jumlah_penduduk', $penduduk->jumlah_penduduk) }}" 
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required min="0">
